...
signed main(){
    ...
    for(int i=2; i<n+2; i++){
        ...
        else if(arr[i-1]>arr[i] && shamin==0 & yasser==1){flag=0;break;}
        else if(arr[i-1]>arr[i] && shamin==0 & yasser==0){shamin=1;  yasser=1; l=i-1;    r=i;}
        else if(arr[i-1]>arr[i] && shamin==1 & yasser==1){r=i;}
        else if(arr[i-1]<arr[i] && shamin==1 & yasser==1){
            if(arr[r]>arr[l-1]&& arr[l]<arr[r+1]){shamin=0;}
            else{flag=0; break;}
        }
    }
    if(flag==1){
