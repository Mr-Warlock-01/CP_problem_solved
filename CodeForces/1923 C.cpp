...
bool Os_Power_of_Two(int n){return (n && !(n & (n - 1)));}
...
int Count_One(int n) {int count = 0; while (n) {count++; n = n & (n - 1);} return count;}   //bionary one count
