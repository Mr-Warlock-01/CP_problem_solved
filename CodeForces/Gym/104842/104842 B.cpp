...
void pikachu(){         ///MAIN  (DRINK WATER)
    ...
    while(q--){
        ...
        string p1_team;      cin>>p1_team;
        string sc_re;   cin>>sc_re;
        ...
        if(sc_re=="scored"){
            ...
            string p_out;       cin>>p_out;
            string with;        cin>>with;
            string p_in;        cin>>p_in;
            ...
            if(p1_team==t1){
                ...
                for(int i=0; i<v1.size(); i++){
                    if(p_in==v1[i].first){haha=0;   break;}
                }
                if(haha){
                    x++;
                    v1.push_back({p_in, x});
                ...
                for(int i=0; i<v2.size(); i++){
                    if(p_in==v2[i].first){haha=0;   break;}
                }
                if(haha){
                    x++;
                    v2.push_back({p_in, x});
    ...
    for(int i=0; i<5;  i++){
        cout<<v1[i].first<<" ("<<t1<<") ";
        if(m[v1[i].first+"1"]>0){cout<<"+";}
        cout<<m[v1[i].first+"1"]<<endl;
    }
    for(int i=0; i<5;  i++){
        cout<<v2[i].first<<" ("<<t2<<") ";
        if(m[v2[i].first+"2"]>0){cout<<"+";}
        cout<<m[v2[i].first+"2"]<<endl;
    }
    int aa=5, bb=5;
    ...
    for(int i=11; i<=x;  i++){
        int haha=0;
        if(aa<v1.size()){
            if(v1[aa].second==i){haha=1;    aa++;}
            else{bb++;  haha=2;}
        }
        else{bb++;  haha=2;}

        if(haha==1){
            cout<<v1[aa-1].first<<" ("<<t1<<") ";
            if(m[v1[aa-1].first+"1"]>0){cout<<"+";}
            cout<<m[v1[aa-1].first+"1"]<<endl;
        }
        else{
            cout<<v2[bb-1].first<<" ("<<t2<<") ";
            if(m[v2[bb-1].first+"2"]>0){cout<<"+";}
            cout<<m[v2[bb-1].first+"2"]<<endl;
        }
    }
}
