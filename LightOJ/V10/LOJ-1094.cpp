...
void dfs(int x, vector<int>&visit, vector<pair<int ,int>>graph[]) {
...
void pikachu(int T){         ///MAIN  (DRINK WATER)
    ...
    visit[0]=1;
    dfs(0,visit,graph);
    visit[0]=0;     visit[corner_point]=1;     weight_sum=0;    max_weight_sum=0;
    dfs(corner_point, visit, graph);
    cout<<"Case "<<T<<": ";
