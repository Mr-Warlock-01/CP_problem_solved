...
int dp[1<<10];    // 0 1 2
                    // 3 4 5 
                    // 6 7 8
bool a1, b1, c1, a2, b2, c2, a3, b3, c3;
...
bool check(int mask){
    ...
    if((a1==1) && (a2==1) && (a3==1)){return 1;}
    if((b1==1) && (b2==1) && (b3==1)){return 1;}
    if((c1==1) && (c2==1) && (c3==1)){return 1;}
    
    if((a1==1) && (b1==1) && (c1==1)){return 1;}
    if((a2==1) && (b2==1) && (c2==1)){return 1;}
    if((a3==1) && (b3==1) && (c3==1)){return 1;}

    if((a1==1) && (b2==1) && (c3==1)){return 1;}
    if((a3==1) && (b2==1) && (c1==1)){return 1;}
    return 0;
}
    
bool xxx(int mask){
    if(dp[mask]!=-1){return dp[mask];}
    if(check(mask)){return 1;}
