...
signed main(){
    ...
    while(tc--){
        ...
        bool flag[3]={0,0,0};
        for(int i=0; i<3; i++){
           if(arr[x][i]=='A'){flag[0]=1;}
           else if(arr[x][i]=='B'){flag[1]=1;}
           else if(arr[x][i]=='C'){flag[2]=1;}
        }
        if(flag[0]==0){cout<<"A"<<endl;}
        else if(flag[1]==0){cout<<"B"<<endl;}
        else if(flag[2]==0){cout<<"C"<<endl;}
    }
return 0;
}