...
void pikachu(int T){         ///MAIN  (DRINK WATER)
    ...
    while(n){
        if(n%2){
            int AAA = ( ((x1*y11)%MOD) + ((x2*y21)%MOD) )%MOD;
            int BBB = ( ((x1*y12)%MOD) + ((x2*y22)%MOD) )%MOD;
            x1=AAA; x2=BBB;
        }

        int AAA = ( ((y11*y11)%MOD) + ((y12*y21)%MOD) )%MOD;
        int BBB = ( ((y11*y12)%MOD) + ((y12*y22)%MOD) )%MOD;
        int CCC = ( ((y21*y11)%MOD) + ((y21*y22)%MOD) )%MOD;
        int DDD = ( ((y21*y12)%MOD) + ((y22*y22)%MOD) )%MOD;
        n/=2;
        y11=AAA;    y12=BBB;    y21=CCC;    y22=DDD;
    }
    cout<<x1;
}
