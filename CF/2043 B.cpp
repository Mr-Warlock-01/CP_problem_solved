...
void solve(int T){            ///   (DRINK WATER)
    ...
    if(d==1){
        if(n==2){cout<<"1"<<endl;}
        else if(n==3 || n==4 || n==5){cout<<"1 3 7"<<endl;}
        else{cout<<"1 3 7 9"<<endl;}
    }
        ...
        if(n==2){cout<<"1 5"<<endl;}
        else if(n==3 || n==4 || n==5){cout<<"1 3 5 7"<<endl;}
        else{cout<<"1 3 5 7 9"<<endl;}
    }
